...
csv_path = os.path.join(script_dir, 'alumnos_actualizado.csv')
...
df.loc[df['Nombre'] == 'Pedro', 'Programacion'] = 6.5
df.loc[df['Nombre'] == 'Carlos', 'Sistemas'] = 5.5

df.to_csv(csv_path, index=False)
print(f"Notas modificadas y guardadas en: {csv_path}")
