...
class Desktop(QWidget):
    ...
    def create_icon_area(self):
        ...
        apps = [
            ("Calculadora", self.launch_calculadora, "assets/a7ff2ee0-92e0-404f-a546-802f3f2df73c.png"),
            ("Bloc de Notas", self.launch_bloc_notas, "assets/4a08f9cc-8300-4bd9-802a-f610025ab564.png"),
            ("Cambiar Fondo", self.launch_cambiar_fondo, "assets/8dfdfb40-96b8-4fa3-bd33-a2a619a9ce73.png"),
            ("Visor Imágenes", self.launch_visor_imagenes, "assets/eb81d271-9c9a-4782-b04f-9980bc9a0aca.png"),
        ]
    ...
    def set_default_wallpaper(self):
        ...
        """
        # Intentar cargar fondo desde assets
        default_path = os.path.join("assets", "default_wallpaper.jpg")
